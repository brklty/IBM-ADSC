...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df,
            values="class",
            names="Launch Site",
            title=f'Total Success Launches By Site for {entered_site}'.format(),)
        return fig
        ...
        fig = px.pie(filtered_df,            
            names="class",
            title=f'Total Success Launches for {entered_site}'.format(),)
        return fig  
...
def get_scatter_slider_chart(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        y = 'class',
        color = 'Booster Version Category',
        title = f'Correlation between Payload Mass and Successs for {entered_site} site'.format(),)
        return fig
